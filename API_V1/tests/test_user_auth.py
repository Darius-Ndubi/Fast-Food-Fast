...
def test_signup_poor_passwords():
    result = app.test_client()
    response = result.post('/api/v1/auth/signup', data=json.dumps(mock_reg[7]),content_type='application/json')
    json.loads(response.data.decode('utf-8'))
    assert(response.status_code == 400)
...
def test_signup_int_username():
    result = app.test_client()
    response = result.post('/api/v1/auth/signup', data=json.dumps(mock_reg[8]),content_type='application/json')
    json.loads(response.data.decode('utf-8'))
    assert(response.status_code == 400)

def test_signup_empty_username():
    result = app.test_client()
    response = result.post('/api/v1/auth/signup', data=json.dumps(mock_reg[9]),content_type='application/json')
    json.loads(response.data.decode('utf-8'))
    assert(response.status_code == 400)

def test_signup_spaces_username():
    result = app.test_client()
    response = result.post('/api/v1/auth/signup', data=json.dumps(mock_reg[10]),content_type='application/json')
    json.loads(response.data.decode('utf-8'))
    assert(response.status_code == 400)
...
def test_signin_int_email():
    result = app.test_client()
    response = result.post('/api/v1/auth/signin', data=json.dumps(mock_log[0]),content_type='application/json')
    json.loads(response.data.decode('utf-8'))
    assert(response.status_code == 400)

def test_signin_empty_email():
    result = app.test_client()
    response = result.post('/api/v1/auth/signin', data=json.dumps(mock_log[1]),content_type='application/json')
    json.loads(response.data.decode('utf-8'))
    assert(response.status_code == 400)

def test_signin_wrong_email1():
    result = app.test_client()
    response = result.post('/api/v1/auth/signin', data=json.dumps(mock_log[2]),content_type='application/json')
    json.loads(response.data.decode('utf-8'))
    assert(response.status_code == 400)

def test_signin_wrong_email2():
    result = app.test_client()
    response = result.post('/api/v1/auth/signin', data=json.dumps(mock_log[3]),content_type='application/json')
    json.loads(response.data.decode('utf-8'))
    assert(response.status_code == 400)
...
def test_signin_int_password():
    result = app.test_client()
    response = result.post('/api/v1/auth/signin', data=json.dumps(mock_log[4]),content_type='application/json')
    json.loads(response.data.decode('utf-8'))
    assert(response.status_code == 400)

def test_signin_poor_password():
    result = app.test_client()
    response = result.post('/api/v1/auth/signin', data=json.dumps(mock_log[5]),content_type='application/json')
    json.loads(response.data.decode('utf-8'))
    assert(response.status_code == 400)
